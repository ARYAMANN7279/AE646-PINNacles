...
\begin{itemize}[nosep]
  ...
  \item \textbf{Optimiser}: AdamW (decoupled weight decay), learning rate $10^{-3}$, cosine annealing schedule (min LR $10^{-5}$).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{figures/fig1_error_histogram.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.58\textwidth]{figures/fig3_superres.pdf}
...
\begin{itemize}[nosep]
  ...
  \item \texttt{stage1/}, \texttt{stage2/}, \texttt{stage3/} --- the deliverables for each project stage.
\end{itemize}
