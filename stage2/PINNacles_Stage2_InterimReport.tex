...
Key observations:
\begin{enumerate}[nosep]
  \item The FNO achieves $37\%$ lower mean error than the MLP while using $9\times$ fewer parameters, demonstrating the advantage of spectral inductive biases for smooth PDE solutions.
...
\begin{itemize}[nosep]
  ...
  \item \texttt{stage1/}, \texttt{stage2/} - the deliverables for each project stage.
\end{itemize}
