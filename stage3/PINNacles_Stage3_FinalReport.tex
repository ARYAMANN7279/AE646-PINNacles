...
\begin{figure}[H]\centering\includegraphics[width=0.8\linewidth]{fig_recipe_ablation.pdf}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{fig_arch_sweeps.pdf}
...
\begin{subfigure}{0.49\linewidth}\centering\includegraphics[width=\linewidth]{fig_data_scaling.pdf}\caption{Data scaling}\end{subfigure}
\begin{subfigure}{0.40\linewidth}\centering\includegraphics[width=\linewidth]{fig_resolution.pdf}\caption{Train vs.\ evaluation resolution}\end{subfigure}
...
\begin{figure}[H]\centering\includegraphics[width=0.72\linewidth]{fig_pareto.pdf}
...
\begin{figure}[H]\centering\includegraphics[width=\linewidth]{fig_diagnostics.pdf}
...
\begin{figure}[H]\centering\includegraphics[width=0.66\linewidth]{fig_samples.pdf}
...
\newpage
\section*{Individual Contribution Statement and AI-Tool-Use Declaration}
\small
\begin{tabular}{@{}p{0.25\linewidth}p{0.71\linewidth}@{}}
\toprule
\textbf{Team member} & \textbf{Contribution}\\\midrule
Aryamann\,Srivastava & Problem formulation and literature review; data pipeline (download, preprocessing, 900/100/200 split); \texttt{MLPBaseline}, \texttt{FNO2d}; Stage~2 training, evaluation, profiling, EDA and ablation scripts and figures; Stage~3 study: \texttt{stage3\_train.py}, job queue, finite-volume solver with calibration and timing, latency benchmark, physical diagnostics, aggregation and figures; ran all $\approx$140 Stage~3 runs on the lab GPU workstation; Stage~1--3 reports and presentations.\\
Varun Sathaye & \textcolor{red}{[to be filled in by Varun: specific tasks, files or sections]}\\
Atishay Jain & \textcolor{red}{[to be filled in by Atishay: specific tasks, files or sections]}\\
Vedant S.\ Tiwari & \textcolor{red}{[to be filled in by Vedant: specific tasks, files or sections]}\\\bottomrule
\end{tabular}

\medskip\textbf{AI-tool-use declaration.} In line with the AE646 policy, Claude Code (Anthropic) was used (i)~for coding and debugging of the project scripts, including the Stage~3 experiment framework, solver, benchmarks and diagnostics; (ii)~at our direction, to execute the experiments on the lab workstation and cross-check every number in the reports, slides and README against the stored result files, which uncovered the sub-optimal Stage~2 training recipe and the invalid Stage~2 solver-timing reference reported above; and (iii)~for LaTeX/\texttt{python-pptx} drafting and formatting. The experimental design, results and interpretation were reviewed by the team. All numerical results come from real runs on real data; none were generated or invented by an AI tool.

\medskip\noindent Signatures: \hfill Aryamann Srivastava \quad Varun Sathaye \quad Atishay Jain \quad Vedant S.\ Tiwari
\normalsize
